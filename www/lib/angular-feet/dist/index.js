...
$__System.registerDynamic("6", [], true, function($__require, exports, module) {
  ...
  function getAPI(config, $http) {
    return function(path, callback, params) {
      ...
      return $http(parameters).then(callback, function(response) {
        throw (response);
      });
    };
  }
      ...
      return {
        ...
        project: {
          ...
          update: function(project, callback) {
            ...
            return api('/projects/' + project.id, callback, {
              method: 'PUT',
              params: params
            });
          },
        ...
        users: {
          get: function(id, callback) {
            return api('/users/' + id, callback, {
              method: 'GET',
              params: {fields: 'tags'}
            });
          },
          all: function(callback) {
            return api('/users', callback, {
              method: 'GET',
              params: {fields: 'tags'}
            });
          },
...
$__System.register('1', ['3', '5', '6'], function (_export) {
  ...
  var angular, providers, deps;
  return {
    setters: [function (_) {
      angular = _['default'];
    }, function (_2) {}, function (_3) {
      providers = _3['default'];
    }],
    execute: function () {
      deps = [];

      angular.module('angularFeet', deps).provider(providers);
    }
  };
});
})
